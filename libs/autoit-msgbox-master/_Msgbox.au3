...
#include "../MetroGUI-UDF/MetroUDF-Required/StringSize.au3"
#include-once
#Region Constant
Global Const $_MB_OK_TEXT = 'Ok'
Global Const $_MB_CANCEL_TEXT = 'Back'
Global Const $_MB_YES_TEXT = 'Yes'
Global Const $_MB_NO_TEXT = 'No'
Global Const $_MB_Abort_TEXT = 'Abort'
Global Const $_MB_Retry_TEXT = 'Retry'
Global Const $_MB_Ignore_TEXT = 'Ignore'
Global Const $_MB_Again_TEXT = 'Again'
Global Const $_MB_Continue_TEXT = 'Continue'
#EndRegion Constant
...
; ===============================================================================================================================
_WinAPI_AddFontResourceEx(@ScriptDir & '\libs\autoit-msgbox-master\fontawesome.ttf', $FR_PRIVATE) ; load font
